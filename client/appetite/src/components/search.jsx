...
const Search = ({data, topData, wishlist}) => {

    const topDataId = topData.map(dat => dat.res_num);
    ...
    return ( <>
        ...
        <div className='searchResult'>
            ...
            showList.map(x => wishlist.includes(x.res_num)?
            <ResBlock className="searchResultBlock" key={x.res_num} type={topDataId.includes(x.res_num)?'top':''} obj={x} wished={true} />
            :
            <ResBlock className="searchResultBlock" key={x.res_num} type={topDataId.includes(x.res_num)?'top':''} obj={x} />
            )}
        </div>
    </> );
}
